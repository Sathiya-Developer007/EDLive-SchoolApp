...
List<Map<String, dynamic>> examRows = [];
    ...
    Future<void> fetchExamResults() async {
      ...
      final url = Uri.parse(
          'http://schoolmanagement.canadacentral.cloudapp.azure.com:5000/api/exams/results/student/${widget.studentId}');
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          ...
          setState(() {
            ...
            // Take first term result for grade summary (you can adapt for selectedTerm later)
            if (termResults.isNotEmpty) {
              grade = termResults[0]['overall_grade'] ?? '';
              averageScore = termResults[0]['average_percentage'] ?? '';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          _ReportStat(title: "Grade", value: grade.isEmpty ? "-" : grade),
                          _ReportStat(
                              title: "Average Score", value: averageScore.isEmpty ? "-" : "$averageScore%"),
                          _ReportStat(title: "Class Rank", value: classRank.isEmpty ? "-" : classRank),
                        ],
                      ),
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            // Table Rows
                            ...examRows.map((e) => _buildRow(e['subject']!, e['marks']!)),
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    examRows.fold<int>(0, (prev, e) => prev + int.parse(e['marks'] ?? '0')).toString(),
                                    style: const TextStyle(
                                      fontWeight: FontWeight.bold,
                                      color: Colors.black,
                                    ),
