...
class StudentMessagesPage extends StatefulWidget {
  final int studentId;
  const StudentMessagesPage({Key? key, required this.studentId}) : super(key: key);
...
Column(
  ...
  decoration: BoxDecoration(
    color: msg.isAppreciation ? Colors.green : const Color(0xFF2E3192),
    shape: BoxShape.circle,
  ),
 child: Icon(
  msg.isAppreciation
      ? Icons.thumb_up_alt_rounded 
      : Icons.chat_bubble_outline, // 👈 received msg bubble
  color: Colors.white,
  size: 22,
),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            "${msg.createdAt.toLocal()}".split(" ")[0], // only date
                            style: const TextStyle(
                              fontSize: 12,
                              color: Colors.grey,
                            ),
