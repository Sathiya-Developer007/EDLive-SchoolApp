              ...
              return GestureDetector(
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      buildAchievementImage(item.evidenceUrl, height: 180),
                      Padding(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Student: ${achievement.fullName}",
                style: const TextStyle(fontSize: 14, color: Colors.black54)),
            Text("Category: ${achievement.category}",
                style: const TextStyle(fontSize: 14, color: Colors.black54)),
            Text("Awarded by: ${achievement.awardedBy}",
                style: const TextStyle(fontSize: 14, color: Colors.black54)),
          Text(
  "Date: ${achievement.achievementDate.isNotEmpty ? achievement.achievementDate.split('T').first : 'N/A'}",
  style: const TextStyle(fontSize: 14, color: Colors.black54),
),
   Text("Visibility: ${achievement.visibility}",
                style: const TextStyle(fontSize: 14, color: Colors.black54)),
          ],
        ),
      ),
