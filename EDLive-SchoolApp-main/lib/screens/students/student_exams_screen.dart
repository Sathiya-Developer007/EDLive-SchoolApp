...
class StudentExamsScreen extends StatefulWidget {
  final String classId; // Pass class ID to this screen

  const StudentExamsScreen({super.key, required this.classId});
...
class _StudentExamsScreenState extends State<StudentExamsScreen> {
  ...
  Future<void> loadExams() async {
    try {
      final data = await ExamService.fetchExams(widget.classId);
      setState(() {
        examList = data;
        isLoading = false;
      });
